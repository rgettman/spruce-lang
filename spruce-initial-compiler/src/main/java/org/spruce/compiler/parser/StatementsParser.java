...
import org.spruce.compiler.ast.statements.ASTAssertStatement;
import org.spruce.compiler.ast.statements.ASTBasicForStatement;
import org.spruce.compiler.ast.statements.ASTBlock;
import org.spruce.compiler.ast.statements.ASTBlockStatement;
import org.spruce.compiler.ast.statements.ASTBlockStatements;
import org.spruce.compiler.ast.statements.ASTBreakStatement;
import org.spruce.compiler.ast.statements.ASTCatchClause;
import org.spruce.compiler.ast.statements.ASTCatchFormalParameter;
import org.spruce.compiler.ast.statements.ASTCatchType;
import org.spruce.compiler.ast.statements.ASTCatches;
import org.spruce.compiler.ast.statements.ASTContinueStatement;
import org.spruce.compiler.ast.statements.ASTDoStatement;
import org.spruce.compiler.ast.statements.ASTEnhancedForStatement;
import org.spruce.compiler.ast.statements.ASTExpressionStatement;
import org.spruce.compiler.ast.statements.ASTFallthroughStatement;
import org.spruce.compiler.ast.statements.ASTFinally;
import org.spruce.compiler.ast.statements.ASTForStatement;
import org.spruce.compiler.ast.statements.ASTIfStatement;
import org.spruce.compiler.ast.statements.ASTInit;
import org.spruce.compiler.ast.statements.ASTLocalVariableDeclaration;
import org.spruce.compiler.ast.statements.ASTLocalVariableDeclarationStatement;
import org.spruce.compiler.ast.statements.ASTLocalVariableType;
import org.spruce.compiler.ast.statements.ASTResource;
import org.spruce.compiler.ast.statements.ASTResourceDeclaration;
import org.spruce.compiler.ast.statements.ASTResourceList;
import org.spruce.compiler.ast.statements.ASTResourceSpecification;
import org.spruce.compiler.ast.statements.ASTReturnStatement;
import org.spruce.compiler.ast.statements.ASTStatement;
import org.spruce.compiler.ast.statements.ASTStatementExpression;
import org.spruce.compiler.ast.statements.ASTStatementExpressionList;
import org.spruce.compiler.ast.statements.ASTSwitchBlock;
import org.spruce.compiler.ast.statements.ASTSwitchCase;
import org.spruce.compiler.ast.statements.ASTSwitchCases;
import org.spruce.compiler.ast.statements.ASTSwitchLabel;
import org.spruce.compiler.ast.statements.ASTSwitchStatement;
import org.spruce.compiler.ast.statements.ASTSwitchValue;
import org.spruce.compiler.ast.statements.ASTSwitchValues;
import org.spruce.compiler.ast.statements.ASTSynchronizedStatement;
import org.spruce.compiler.ast.statements.ASTThrowStatement;
import org.spruce.compiler.ast.statements.ASTTryStatement;
...
import org.spruce.compiler.ast.statements.ASTVariableModifier;
import org.spruce.compiler.ast.statements.ASTVariableModifierList;
import org.spruce.compiler.ast.statements.ASTWhileStatement;
