...
import org.spruce.compiler.bootstrap.ast.expressions.ASTBinaryExpression;
import org.spruce.compiler.bootstrap.ast.expressions.ASTUnaryExpression;
...
import static org.spruce.compiler.bootstrap.scanner.TokenType.EXCLAMATION;
import static org.spruce.compiler.bootstrap.scanner.TokenType.MINUS;

/**
 * An <code>OperatorsResolver</code> is a <code>BasicResolver</code> that
 ...
 */
public class OperatorsResolver extends BasicResolver {
    /**
     * Constructs an <code>OperatorsResolver</code>.
     * @param resolver An <code>Resolver</code>.
     * @param msgProducer A <code>MessageProducer</code>.
     * @param global The <code>GlobalLookup</code>.
     */
    public OperatorsResolver(Resolver resolver, MessageProducer msgProducer, GlobalLookup global) {
